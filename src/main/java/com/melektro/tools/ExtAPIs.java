...
public class ExtAPIs
{
    ...
    public static String GetIssWhen(String ProxyToUse, String ProxyPortToUse, String lat, String lon, String count, Integer gmt) throws IOException
    {
        ...
        final IssRootObjectStr rootObjStr = new IssRootObjectStr();
        ...
        rootObjStr.response = new ArrayList<>();
    ...
    public static String GetSerres_Formatted() throws IOException, InterruptedException
    {
